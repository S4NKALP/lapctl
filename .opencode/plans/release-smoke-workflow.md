...
## File to Create: `.github/workflows/release-smoke.yml`
...
## Also Required: Update Cargo.toml for crates.io

Add these fields under `[package]`:

```toml
description = "CLI tool for managing laptop hardware features on Linux"
license = "MIT"
repository = "https://github.com/S4NKALP/lapctl"
```
